...
const ViewCourse = ({ open, handleClose, courseData }: TModal) => {
            ...
            <div className="w-full flex flex-col gap-10">
                ...
                <section className="max-h-[65vh] w-full flex flex-col gap-4 overflow-y-auto scrollbar-none">
                    <div>
                        ...
                        <p className="text-gray-600">{courseData.course_name}</p>
                    </div>

                    <div>
                        <h3 className="font-semibold text-gray-800 mb-2">Course Code</h3>
                        <p className="text-gray-600">{courseData.course_code}</p>
                    </div>
                    ...
                    <div className="flex justify-between">
                        ...
                        <div>
                            ...
                            <p className={`font-medium ${courseData.status === 'Active' ? 'text-green-600' : 'text-red-600'
                                }`}>
                                {courseData.status}
                            </p>
                        </div>

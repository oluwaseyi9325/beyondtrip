...
// ------------------------------------------------
// Validation Schema (Fixed to match TypeScript types)
// ------------------------------------------------
const schema: yup.ObjectSchema<ProfileDetailsForm> = yup.object().shape({
    ...
    confirmNewPassword: yup
        ...
        .test("passwords-match", "Passwords must match", function (value) {
            ...
            if (!newPassword) return true; // No validation if newPassword is empty
    ...
    return (
        <div className="w-full">
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
                <div className="bg-white p-4 sm:p-6 lg:p-8 rounded-lg space-y-8">
                    {/* Header */}
                    <div className="flex flex-wrap gap-2 items-center justify-between">
                        <h2 className="text-lg sm:text-xl font-bold text-gray-900">Profile Details</h2>
                        <button
                            type="button"
                ...
                {isEditMode && (
                    <div className="flex flex-col sm:flex-row gap-4 pt-6">
                        <Button
                            type="submit"
                            size="md"
                            className="!w-full sm:!w-auto px-8 sm:px-12 bg-[#336AEA] text-white rounded-lg font-medium hover:bg-[#2952b8] transition-colors"
                        >
                            Save Changes
                        </Button>
                        <Button
                            ...
                            borderColor="#336AEA"
                            borderWidth="1"
                            className="!w-full sm:!w-auto px-8 sm:px-12 bg-white text-[#336AEA] rounded-lg font-medium hover:bg-gray-50 transition-colors"

                        ...
                        {assignments.map((item: any, i: any) => (
                            ...
                            >
                                ...
                                <div className="p-4 border-t border-slate-400">
                                    <Link href={`/tutor/class/assignment/${item?.id}/`} className="w-full block text-center bg-[#171313] text-white py-2 px-4 rounded-md font-semibold hover:bg-[#2c2c2c] transition-colors duration-200">
                                        View Submissions
                                    </Link>
                                </div>
                            </div>

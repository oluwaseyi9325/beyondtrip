        ...
        <div className="bg-white border mb-3 border-gray-200 rounded-2xl p-6 shadow-sm col-span-2 flex flex-col justify-between">
          ...
          <div className="flex items-center flex-wrap justify-between gap-4">
            <div className="flex items-center gap-3">
              <div className="h-12 w-12 uppercase rounded-full bg-[#2C4C9C] flex items-center justify-center text-white font-semibold">
                {bankName?.[0]}
              </div>
              <div>
            ...
            <Button
              ...
              className="w-auto!  bg-[#336AEA] text-white px-20 py-2.5 rounded-lg font-medium hover:bg-[#2952b8] transition-colors whitespace-nowrap"
            >
              Edit Bank Details
            </Button>
          </div>

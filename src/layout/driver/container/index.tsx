...
import { useGetTutorMe } from "@/services/auth.service";
...
const Container = ({ children, active, search, handleSearch }: TProps) => {
  ...
  // const { data: response } = useGetTutorMe();
  ...
  return (
    ...
    <main className="bg-[#F4F4F4] min-h-screen md:grid md:grid-cols-[300px_1fr] gap- relative">
    {/* Overlay on mobile */}
    {showSidebar && (

      ...
      <div className="bg-white rounded-lg p-6 sm:p-12 lg:p-20">
        <div className="p-6 sm:p-12 lg:p-20 border border-[#00000040] rounded-3xl  ">
          ...
          >
            ...
            {/* Buttons */}
            <div className="flex flex-col sm:flex-row mx-8 gap-4 mt-4">
              <Button
                type="submit"
                size="md"
                className=" px-12 bg-[#336AEA] text-white rounded-lg font-medium hover:bg-[#2952b8] transition-colors"
              >
                Update Campaign
              </Button>
              ...
              <Button
                ...
                borderColor="#336AEA"
                borderWidth="1"
                className=" px-12 bg-white text-[#336AEA] rounded-lg font-medium hover:bg-gray-50 transition-colors"
